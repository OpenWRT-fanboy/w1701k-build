...
setup_envs() {
  # Do not change
  BUILDER_IMAGE_ID_BUILDENV="ghcr.io/w1700k/fastbuild_base:debian-arm"
  ...
  source "${HOST_WORK_DIR}/scripts/host/ghcr.sh"
  # shellcheck disable=SC1090
...
update_builder_info() {
  local builder_full_name="ghcr.io/openwrt-fanboy/builder"
